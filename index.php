        ...
        <div class="row text-center ">
            ...
            <div class="col-6 col-md-3 py-3 " >
                <a href="products.php#shirt"  >
                  <img src="images/clothing.jfif" class="img-fluid zoom" alt="" style="border-radius:0.5rem" >
                     <div class="h5 pt-3 font-weight-bolder">
                        Clothing
                     </div>
                  </a>
            ...
            <div class="col-6 col-md-3 py-3">
                <a href="products.php#shoes">
                 <img src="images/shoes.jfif" class="img-fluid   " alt="" style="border-radius:0.5rem">
                <div class="h5 pt-3 font-weight-bolder">
                    Shoes
                 </div>
             </a>
