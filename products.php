<?php
//require_once __DIR__ . '/cart-input.php';
session_start();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Melisa Shopify | Online Shopping</title>
...
<div class="container" style="margin-top:65px">
        ...
        <div class="jumbotron text-center">
            <h1>Welcome to Melisa Shopify!</h1>
    ...
    <div class="row text-center" id="shirt">
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    <img src="images/batik1.jpeg" alt="" class="img-fluid pb-1"  >
                    <div class="figure-caption">
                    <h6>Blouse Batik Sutra</h6>
                    <h6>Price :Rp 180000</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                    <img src="images/batik2.jpeg" alt="" class="img-fluid pb-1" >
                    <div class="figure-caption">
                    <h6>Blouse Batik Dibo</h6>
                    <h6>Price :Rp 250000</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                    <img src="images/batik3.jpeg" alt="" class="img-fluid pb-1">
                    <div class="figure-caption">
                        <h6>Highbatik Serat</h6>
                        <h6>Price :Rp 500000</h6>
                        <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                    } else {
            ...
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    <img src="images/batik4.jfif" alt="" class="img-fluid pb-1">
                    <div class="figure-caption">
                        <h6>Katuna Blouse Batik</h6>
                        <h6>Price :Rp 230000</h6>
                        <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                    } else {
