    ...
    <div class="container mt-5 ">
      <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          <h3 class="text-warning pt-3 title">Who We Are ?</h3><br>
          <hr />
          <img
        ...
        <div class="col-md-5 mt-3">
          ...
          <hr>
          <p>Shopping center "Melisa Shopify" which forms in 2022 with modern technology. 
            Throughout the time in our company suitable temperatures and a comfortable climate.</br>

          <br>Here, you will find a lot of the items you are looking for. 
          Seeing good things can immediately check out at a very friendly price. A clean and beautiful company is a pride for us to make customer comfort. 
          You will be amazed by the beauty and completeness of all the items you expect.</br>

          <br>Please be able to buy our products, then we will provide attractive promos! </br>
