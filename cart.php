                ...
                ?>
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            $sum += $row["Price"];
                            $id = $row["id"] . ", ";
                            echo "<tr><td>" . "#" . $row["id"] . "</td><td>" . $row["Name"] . "</td><td>Rp " . $row["Price"] 
                            . "</td><td><a href='cart-remove.php?id={$row['id']}' class='remove_item_link'> Remove</a></td></tr>";
                        }
                        $id = rtrim($id, ", ");
                        echo "<tr><td></td><td>Total</td><td>Rp " . $sum 
                        . "</td><td><a href='success.php' class='btn btn-primary'>Order</a>
                        <a href='products.php' class='btn btn-primary'> Add</a> </td></tr>";
